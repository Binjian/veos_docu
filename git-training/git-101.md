...
<span style="color:#004394; font-size:40pt;">Git使用的心理模型</span>

<span style="color:#004394; font-size:30pt;"> 基础和日常使用 </span>
---
[<span style="color:#004394; font-size:25pt;"> &nbsp; &emsp; 忻斌健</span>](#Git)

<span style="color:#004394; font-size:25pt;"> 2026年03月31日 </span>
...
- 哈希冲突
  ...
  - 自V2.29(Oct. 2020) 开始尝试SHA-256（SHA-2,32字节) 
    - $2^{256}\approx \frac{1}{4}\cdot10^{80}$
  - 哈希冲突概率 $\rightarrow 4.3\times10^{-64}$
...
- 暂存区 (Index, git add / git restore --staged)
  ...
  - git reset --hard: 变更数据库(HEAD)-->暂存区-->工作区
  - git reset --mixed: 变更数据库(HEAD)-->暂存区(默认)
